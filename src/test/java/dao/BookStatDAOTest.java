...
public class BookStatDAOTest {
    ...
    public void testGetBookStatistic() throws Exception {
        ...
        assertEquals("Conan", result.get(2).getTitle());
        assertEquals(4, result.get(2).getBookId());
        assertEquals(3, result.get(2).getBorrowedTime());
        
        assertEquals("Doraemon", result.get(3).getTitle());
        assertEquals(5, result.get(3).getBookId());
        assertEquals(2, result.get(3).getBorrowedTime());
